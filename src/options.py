...
parser.add_argument(
    "--beta_a", type=float, default=1.0,
    help="beta in the beta distribution",
)
parser.add_argument(
    "--cluster_cons_weight", type=float, default=0.1,
    help="the weight of cluster consistency loss",
)
parser.add_argument(
    "--mixup_weight", type=float, default=1.0,
    help="the weight of cluster consistency loss",
)
parser.add_argument(
    "--cluster_rec_num_image", type=int, default=0,
    help="the cluster of image for reconstruction",
)
parser.add_argument(
    "--cluster_rec_num_text", type=int, default=0,
    help="the cluster of text for reconstruction",
)

parser.add_argument(
    "--K_image", type=int, default=15,
    help="the group numbers of image features",
)
parser.add_argument(
    "--mixmemory_length", type=int, default=500,
    help="the length of mix memory",
)
parser.add_argument(
    "--K_text", type=int, default=5,
    help="the group numbers of text features",
)
parser.add_argument(
...
parser.add_argument(
    "--data_path", type=str, default="/***/datasets/nsd",
